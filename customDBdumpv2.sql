...
CREATE TABLE `todoassignment` (
  ...
  KEY `todoid_idx` (`todoid`,`assigneeid`),
  CONSTRAINT `assigneeid` FOREIGN KEY (`assigneeid`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `todoid` FOREIGN KEY (`todoid`) REFERENCES `todoitem` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `todoitem` VALUES (1,'Pick up meds','2016-12-09 11:11:56','2016-12-31 14:27:56',0,NULL,0,'Pick up my husband\'s meds from the pharmacy and put them into the daily pill box for him',1),(2,'Water the cacti','2016-12-09 11:12:52','2016-12-09 11:12:52',0,NULL,0,'The cacti should be watered once a month, so I should do it this week and also create a new todo item to water them next month',1),(3,'Finish knitting mittens','2016-12-09 11:13:33','2016-12-31 12:27:56',1,'2016-12-14 15:30:48',0,'I will see the grandchildren this weekend, and the mittens should be finished by then.',1),(4,'Send postcard to neice','2016-12-09 11:14:46','2016-12-09 11:14:46',0,NULL,0,'Neice\'s birthday coming up soon, so I should send a postcard',2),(5,'Pick up drycleaning','2016-12-09 11:15:07','2016-12-09 11:15:07',0,NULL,0,'Pick up suit from drycleaners',2),(6,'Hoi','2016-12-14 14:36:26','2020-12-31 10:38:38',0,NULL,0,'',4),(9,'Untitled','2016-12-14 14:57:05','2016-12-21 14:57:05',0,NULL,0,'',3),(10,'Untitled','2016-12-14 15:48:09','2016-12-21 15:48:09',0,NULL,0,'',3),(21,'Untitled','2016-12-14 17:11:51','2016-12-21 17:11:51',0,NULL,0,'',4);
...
INSERT INTO `user` VALUES (1,'dawnm','dawnmeadows@gmail.com','dawnm','2016-12-09 10:59:00','Dawn Meadows'),(2,'john1','johndavies@gmail.com','johnd','2016-12-09 10:59:45','John Davies'),(3,'gaaron','g_aaron@gmail.com','cats','2016-12-09 11:00:37','Gary Aaron'),(4,'a','piet@gmail.com','a','2016-12-14 14:36:12','Aafje Asl');
...
-- Dump completed on 2016-12-21 17:13:03
